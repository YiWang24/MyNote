...
export const Thread = () => {
  return (
    (<ThreadPrimitive.Root className="bg-background box-border h-full">
      <ThreadPrimitive.Viewport
        ...
        <div
          className="max-w-aui-thread sticky bottom-0 mt-3 flex w-full flex-col items-center justify-end rounded-t-lg bg-inherit pb-4">
...
const UserMessage = () => {
  return (
    (<MessagePrimitive.Root
      className="grid auto-rows-auto grid-cols-[minmax(72px,1fr)_auto] gap-y-2 [&>*]:col-start-2 max-w-aui-thread w-full py-4">
      <UserActionBar />
      {/* <MessageAttachments > */}
      <div
...
const EditComposer = () => {
  return (
    (<ComposerPrimitive.Root
      className="bg-muted max-w-aui-thread my-4 flex w-full flex-col gap-2 rounded-xl">
      <ComposerPrimitive.Input
...
const AssistantMessage = () => {
  return (
    (<MessagePrimitive.Root
      className="grid grid-cols-[auto_auto_1fr] grid-rows-[auto_1fr] max-w-aui-thread relative w-full py-4">
